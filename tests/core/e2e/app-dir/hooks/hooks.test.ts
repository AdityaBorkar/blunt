...
describe('app dir - hooks', () => {
	...
	describe('from pages', () => {
		it.each([
			...
			{ keyValue: 'value', pathname: '/adapter-hooks/static' },
			{ keyValue: 'value', pathname: '/adapter-hooks/1' },
			{ keyValue: 'value', pathname: '/adapter-hooks/2' },
			{ keyValue: 'value', pathname: '/adapter-hooks/1/account' },
		])(
