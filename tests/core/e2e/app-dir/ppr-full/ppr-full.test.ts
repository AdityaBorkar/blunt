...
const pages: Page[] = [
	{ dynamic: true, pathname: '/' },
	{ dynamic: true, pathname: '/nested/a', revalidate: 120 },
	{ dynamic: true, pathname: '/nested/b', revalidate: 120 },
	{ dynamic: true, pathname: '/nested/c', revalidate: 120 },
	{ dynamic: true, pathname: '/metadata', revalidate: 120 },
	{ dynamic: true, pathname: '/on-demand/a' },
	{ dynamic: true, pathname: '/on-demand/b' },
	{ dynamic: true, pathname: '/on-demand/c' },
	{ dynamic: true, pathname: '/loading/a', revalidate: 120 },
	{ dynamic: true, pathname: '/loading/b', revalidate: 120 },
	{ dynamic: true, pathname: '/loading/c', revalidate: 120 },
	{ dynamic: false, pathname: '/static' },
	{ dynamic: true, emptyStaticPart: true, pathname: '/no-suspense' },
	{ dynamic: true, emptyStaticPart: true, pathname: '/no-suspense/nested/a' },
	{ dynamic: true, emptyStaticPart: true, pathname: '/no-suspense/nested/b' },
	{ dynamic: true, emptyStaticPart: true, pathname: '/no-suspense/nested/c' },
	{ dynamic: 'force-dynamic', pathname: '/dynamic/force-dynamic' },
	{ dynamic: 'force-dynamic', pathname: '/dynamic/force-dynamic/nested/a' },
	{ dynamic: 'force-dynamic', pathname: '/dynamic/force-dynamic/nested/b' },
	{ dynamic: 'force-dynamic', pathname: '/dynamic/force-dynamic/nested/c' },
	{
		...
		describe('HTML Fallback', () => {
			...
			for (let i = 1; i < 2; i++) {
				for (const [pattern, client, nested] of patterns) {
					...
					pathnames.push({ client, pathname: pattern(slug), slug });
				}
			}
			...
			describe('Dynamic Shell', () => {
				...
				if (isNextDeploy) {
					...
					it('will revalidate the page and fallback shell', async () => {
						...
						await retry(async () => {
							$ = await next.render$(pathname);
							revalidatedDynamicID = $('[data-layout]').data(
								'layout',
							) as string;
